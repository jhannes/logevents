...
public class LogEventTest {
    ...
    public void shouldFindLoggingClassWithSlf4j() {
        ...
        StackTraceElement callerLocation = event.extractCallerLocation(new StackTraceElement[]{
                ...
                new StackTraceElement("org.logevents.impl.LevelLoggingEventGenerator", "log", "LevelLoggingEventGenerator.java", 87),
                new StackTraceElement("org.logevents.impl.LevelLoggingEventGenerator", "log", "LevelLoggingEventGenerator.java", 33),
    ...
    public void shouldFindLoggingClassWithJavaUtilLogging() {
        ...
        StackTraceElement callerLocation = event.extractCallerLocation(new StackTraceElement[]{
                ...
                new StackTraceElement("org.logevents.impl.LevelLoggingEventGenerator", "log", "LevelLoggingEventGenerator.java", 87),
                new StackTraceElement("org.logevents.impl.LevelLoggingEventGenerator", "log", "LevelLoggingEventGenerator.java", 33),
                new StackTraceElement("org.logevents.impl.JavaUtilLoggingAdapter", "publish", "JavaUtilLoggingAdapter.java", 62),
