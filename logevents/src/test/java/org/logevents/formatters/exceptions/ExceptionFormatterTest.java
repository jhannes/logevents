...
public class ExceptionFormatterTest {
    ...
    public void shouldFindPackagingInformation() {
        ...
        StackTraceElement[] stackTrace = new StackTraceElement[] {
            ...
            new StackTraceElement(getClass().getName(), "shouldFindPackagingInformation", "ExceptionFormatterTest.java", 175),
            new StackTraceElement("org.logevents.formatters.NoSuchClass", "unknownMethod", "NoSuchClass.java", 17),
