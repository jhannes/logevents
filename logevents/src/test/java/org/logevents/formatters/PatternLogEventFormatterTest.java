...
public class PatternLogEventFormatterTest {
    ...
    public void shouldOutputLocation() {
        ...
        assertEquals("FrameworkMethod.java:59 - org.junit.runners.model.FrameworkMethod$1#runReflectiveCall\n",
                formatter.apply(buffer.singleLogEvent()));
    }
    ...
    public void shouldIncludeExceptionByDefault() {
        ...
        assertEquals("\tat org.logevents.formatters.PatternLogEventFormatterTest.createException(PatternLogEventFormatterTest.java:228)",
                lines[2]);
        assertEquals("\tat org.logevents.formatters.PatternLogEventFormatterTest.shouldIncludeExceptionByDefault(PatternLogEventFormatterTest.java:234)",
                lines[3]);
    }
