...
import static org.logevents.optional.junit.LogEventSampler.HTTP_ASSET_REQUEST;
import static org.logevents.optional.junit.LogEventSampler.HTTP_ERROR;
...
import static org.logevents.optional.junit.LogEventSampler.PERFORMANCE;

public class LogEventFilterTest {

    public LogEventFactory factory = LogEventFactory.getInstance();
    public LogEventLogger parentLogger = factory.getLogger("org.example");
    public LogEventLogger logger = factory.getLogger("org.example.MdcThreshold");
    ...
    public void shouldCombineFilterWithParent() {
        ...
        LogEventLogger childLogger = factory.getLogger("org.example.MdcThreshold.Sublogger");
